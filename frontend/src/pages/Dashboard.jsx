              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                ...
                <span className="text-xs md:text-sm text-gray-300 bg-white/5 px-4 py-2 rounded-full">
                  {fullyPaidApplications.length > 0
                    ? <><FaCheck style={{ color: '#4ade80', marginRight: '5px', verticalAlign: 'middle' }} /> Internship Active</>
              ...
              <div key={app._id} className="glass rounded-2xl p-6 md:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                <div>
                  ...
                  {app.paymentStatus === 'paid' ? (
                    <a 
                      href={`https://internship-6uer.onrender.com/api/applications/download/${app._id}?token=${localStorage.getItem('launchpad_token')}`}
